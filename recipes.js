...
let recipes = {
    ...
    "工作台": {
        type: "工作台",
        map: [["橡木木板", "橡木木板"], ["橡木木板", "橡木木板"]],
        ingredients: [["橡木木板", 4]],
    },
    "火焰弹": {
        type: "工作台",
        map: [["烈焰粉", "煤炭"], [null, "火药"]],
        ingredients: [["烈焰粉"], ["煤炭"], ["火药"]],
        count: 3
    },
    "圆石生成器": {
        type: "增强型工作台",
        map: [["平滑石头", "平滑石头", "平滑石头"], ["熔岩桶", "铁镐", "水桶"], ["平滑石头", "平滑石头", "平滑石头"]],
        ingredients: [["平滑石头", 6], ["熔岩桶"], ["铁镐"], ["水桶"]],
    },
    "砂砾生成器(已损坏)": {
        type: "磨石",
        map: [["圆石生成器", null, null], [null, null, null], [null, null, null]],
        ingredients: [["圆石生成器"]],
    },
    "砂砾生成器": {
        type: "增强型工作台",
        map: [["石砖", "银铜合金锭", "石砖"], ["银铜合金锭", "砂砾生成器(已损坏)", "银铜合金锭"], ["石砖", "银铜合金锭", "石砖"]],
        ingredients: [["石砖", 4], ["银铜合金锭", 4], ["砂砾生成器(已损坏)"]],
    },
    "石砖": {
        type: "工作台",
        map: [["石头", "石头"], ["石头", "石头"]],
